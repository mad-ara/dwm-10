...
static const char *fonts[]          = { "Source Code Pro:size=12", "Font Awesome 5 Brands Regular:size=12:style=bold", "Font Awesome 5 Free Solid:size=12:style=bold", "Font Awesome 5 Free Regular:size=12:style=bold"};
static const char dmenufont[]       = "Hack Nerd Font:size=12";
static const char col_gray[]       = "#aaaaaa";
static const char col_red1[]       = "#ff2222";
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_black, col_yellow, col_black },
...
static Key keys[] = {
    ...
    { MODKEY,                        XK_t,        spawn,       SHCMD("wmctrl -x -a st-256color || st bash -c \"wmctrl -lp | grep $$ | awk '{print $1}' | xargs wmctrl -i -a; bash\"") },
    ...
    { MODKEY,                        XK_g,        spawn,       SHCMD("pgrep mutt && wmctrl -x -a mail || st -c mail -n mail -g 90x40+450+100 bash -c \"wmctrl -x -a mail;mutt\"") },
    ...
    { MODKEY,                        XK_c,        spawn,       SHCMD("killall compton; compton") },
    { MODKEY|ControlMask,            XK_w,   	  spawn,       SHCMD("set-root-color") },
